...
class UsersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        echo "✅ Admin user dibuat: ozaadmin@umkm.com / ozaadmin123\n";

        // 2. User mitra (pemilik UMKM)
        // User mitra utama
        DB::table('users')->insert([
            'name' => 'Oza Mitra',
            'email' => 'ozamitra@umkm.com',
            'email_verified_at' => now(),
        ...
        echo "✅ Mitra user dibuat: ozamitra@umkm.com / ozamitra123\n";
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            echo "📝 Mitra user {$i} dibuat: mitra{$i}@umkm.com / password\n";
        }

        // 3. User BIASA (pembeli)
        DB::table('users')->insert([
            'name' => 'Oza User',
            'email' => 'ozauser@umkm.com',
            'email_verified_at' => now(),
        ...
        echo "✅ User biasa dibuat: ozauser@umkm.com / ozauser123\n";
        ...
        echo str_repeat("=", 40) . "\n";
        echo "ADMIN:\n";
        echo "  Email: ozaadmin@umkm.com\n";
        echo "  Password: ozaadmin123\n";
        echo "  Role: admin\n\n";

        echo "MITRA (Pemilik UMKM):\n";
        echo "  Email: ozamitra@umkm.com\n";
        echo "  Password: ozamitra123\n";
        echo "  Role: mitra\n\n";

        echo "USER (Pembeli):\n";
        echo "  Email: ozauser@umkm.com\n";
